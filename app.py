...
# import the model
pipe=pickle.load(open(r"C:\Users\abipa\pipe.pkl",'rb'))
df = pickle.load(open(r"C:\Users\abipa\mobile_df.pkl",'rb'))

st.title("Mobile Price Predictor")

# Insert a subheader or a title for the mobile image
st.subheader("Here is the mobile model you're predicting for:")

# Insert the mobile image
st.image(r"C:\Users\abipa\OneDrive\Pictures\mobile_image.png", caption="Mobile Image", use_column_width=True)
